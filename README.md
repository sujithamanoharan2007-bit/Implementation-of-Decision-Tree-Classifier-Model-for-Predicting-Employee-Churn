...
## Algorithm
1.Import Libraries & Dataset – Import required libraries and load the employee churn dataset.

2.Data Preprocessing – Clean the data and separate features (X) and target (Y).

3.Train Model – Split data into training and testing sets and train the Decision Tree classifier.

4.Evaluate Model – Predict results and check accuracy of the model. 
